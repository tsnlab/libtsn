...
void do_server_udp(int sock, int size, bool oneway, bool verbose);
void do_client_udp(int sock, char* iface, int size, char* target, int count, bool precise, bool oneway);

void do_server_tcp(int sock, int size, bool oneway, bool verbose);
void do_client_tcp(int sock, char* iface, int size, char* target, int count, bool precise, bool oneway);
...
int main(int argc, char** argv) {
    ...
    if (arguments.mode == RUN_SERVER) {
        if (arguments.pkt_type == PACKET_RAW) {
            ...
            do_server_udp(sock, arguments.size, arguments.oneway, arguments.verbose);
        } else {
            do_server_tcp(sock, arguments.size, arguments.oneway, arguments.verbose);
        }
        ...
        if (arguments.pkt_type == PACKET_RAW) {
            ...
            do_client_udp(sock, arguments.iface, arguments.size, arguments.target, arguments.count, arguments.precise,
                          arguments.oneway);
        } else {
            do_client_tcp(sock, arguments.iface, arguments.size, arguments.target, arguments.count, arguments.precise,
                          arguments.oneway);
        }
    } else {
